...
export default function AbonnementFreelancePage() {
  ...
  const handleAccessDashboard = async () => {
    ...
    // Supprimer les données du formulaire sauvegardées car le profil est maintenant créé
    await AsyncStorage.removeItem(FORM_STORAGE_KEY);
    router.replace('/(freelance)/accueil');
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Choisis ton plan</Text>
        <View style={styles.headerSpacer} />
      </View>

      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        {/* Main Title */}
        <Text style={styles.mainTitle}>Choisis ton plan</Text>
        ...
        {/* Footer Link */}
        <TouchableOpacity onPress={handleReturnToProfile} style={styles.footerLink}>
          <Text style={styles.footerLinkText}>Revenir à la modification de profil</Text>
        </TouchableOpacity>
      </ScrollView>
        ...
        <View style={styles.confirmationModalOverlay}>
          <View style={styles.confirmationModalContent}>
            ...
            <Text style={styles.confirmationModalTitle}>
              Merci ! Ton essai gratuit est activé.
            </Text>
            
            <Text style={styles.confirmationModalSubtitle}>
              Tu peux maintenant accéder aux missions correspondant à ton profil.
            </Text>
